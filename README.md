...
2. Select the iiSU root folder that contains the `iiSULauncher` folder. (/Android/media/com.iisulauncher or /iiSU, depends where the root folder for the emulator files is)
